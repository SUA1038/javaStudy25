...
public class SwitchNoBreakExam2 {
	...
	public static void main(String[] args) {
		...
		case 10 :
			System.out.println("2교시 다음 내용을 교사와 함께 실습 진행합니다.");
			
		case 11 : 
			System.out.println("3교시 다음 내용을 교사와 함께 실습 진행합니다.");
		...
		default :
			System.out.println((time) + "시. 현재 일과 시간이 아닙니다. 휴식하세요.");
