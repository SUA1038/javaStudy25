...
public class CalcuratorExam {
	// 간단한 계산기 프로그램 만들기
	// 입력받기 : 숫자 > 연산자 > 숫자
	// 연산자별로 메서드에 숫자 넣기 (입력받는 순서에 맞춰서 족므 귀찮지만 메서드에서 잘 해결하기)
	// 결과값 main 메서드에서 출력해주기 (return을 받아서)
	// 완료 반복재생 가능하게 while문 사용하기 (다시하겠습니까? or 이어서 계산하시겠습니까?)
		...
		while(run) {
			...
			while(run2) { // while(run2)
				...
				default :
					...
					System.out.println("숫자를 잘못 선택하였습니다. \n다시 입력해주세요\n");
				} // switch 문 end
			} 
		}
