...
// 추가 메서드 활용 (동작 부분을 따로 만듦 -> 관심사의 분리(oop 핵심))
static String WhoIsIt(String Monster) { // 매개값으로 main()넘어온 문자열을 처리
	String kind = "미지의 생물"; // 출력용 변수 선언 및 초기값 핵심
	switch(Monster) {
	case "호랑이", "사자", "강아지", "개", "고양이", "고래" -> kind = "포유류";
